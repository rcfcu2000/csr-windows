...
namespace csr_windows.Client.Services.WebService
{
    ...
    class SunnyPublic
    {
        ...
        /// <param name="消息类型"> 1=SendString  2=接受 </param>
